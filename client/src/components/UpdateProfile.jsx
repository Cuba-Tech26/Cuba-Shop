      ...
      >
        <div className="mb-3 inputRegBox">
          ...
          {errors?.username?.message && (
            <p className="text-denger fs-6">{errors.username.message}</p>
          )}
        </div>
        <div className="mb-3 inputRegBox">
          <input
          ...
          />
          {errors?.username?.message && (
            <p className="text-denger fs-6">{errors.email.message}</p>
          )}
        </div>
        <div
        ...
        {errors?.password?.message && (
          <p className="text-denger fs-6">{errors.password.message}</p>
        )}
