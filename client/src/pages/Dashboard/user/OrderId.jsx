      ...
      {loading ? (
        ...
        <Row>
          ...
          <Col md={6} className="mb-3">
            ...
            <p className="fs-6 mb-1">Delivery fee:{formatCurrency(data.shippingPrice)}</p>
          ...
          <Col md={6} className="mb-3">
            ...
            <p className="fs-6 mb-1">Reciever: {data.shippingDetails?.fullname}</p>
            ...
            <p className="fs-6 text-capitalize mb-1">name: {data?.user?.username}</p>
