                  ...
                  >
                    <Col xs={12} md={5} lg={6} className="mb-3">
                      <div className="d-flex align-items-center gap-2 flex-wrap">
                        <Link
                          to={`/collections/${order.orderItems[0]?.category}/${
                            order.orderItems[0]?.slug
                          }`}
                        >
                          <Image
                        ...
                        <p className="fs-6 mb-1"><span className="fw-bold me-1">OrderId:</span>
                         {order._id}
                        </p>
                        </div>
                      </div>
                    ...
                    <Col xs={12} md={3} lg={2} className="mb-3 text-center">
                      <Link to={`/account/${username}/orders/${order._id}`}>
                        <Button variant="danger" className="rounded-0 fw-medium">See Detail</Button>
                      </Link>  
                    </Col>
                  </Row>
                ))}
