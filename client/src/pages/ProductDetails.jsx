...
export default function ProductDetails() {
  ...
  console.log("cat", suggestedProducts);
  ...
  const handleLike = async () => {
    try {
      ...
      toast.error("Unable to like pin, pls login first");
    }
  };
    ...
    <>
      ...
      <Container className="mt-4 mx-auto">
        ...
        {loading ? (
          ...
          <div>
            <BsArrowLeftCircle
              className="d-none d-lg-block position-absolute top-50 start-0
              translate-middle text-black z-2"
              size="1.8rem"
              style={{ cursor: "pointer" }}
              onClick={() => scroll("left")}
            />
            ...
            <BsArrowRightCircle
              className=" d-none d-lg-block position-absolute top-50 start-100
              translate-middle text-black z-2"
              size="1.8rem"
              style={{ cursor: "pointer" }}
            ...
            />
            <div
              className="d-flex gap-4 overflow-x-auto over h-100"
              ref={scrollRef}
            >
